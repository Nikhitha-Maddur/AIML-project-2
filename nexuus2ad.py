    ...
    def respond(self, user_input):
        responses = {
            ...
            "scholarships": "We offer various scholarships based on merit and need. You can apply for scholarships along with your admission application.",
             "How accessible are the faculty members to students?": "Faculty members have scheduled office hours each week, and many are open to meeting by appointment. Additionally, we encourage a culture of mentorship where professors actively engage with students outside of the classroom.",
            "What extracurricular activities or clubs does your college offer?": "Music, Dance, sport and clubs",
            "What are the campus safety measures?": "Campus safety is a top priority. We have 24/7 campus security, emergency call stations, and a shuttle service that operates late into the night. Additionally, we conduct regular safety drills and offer various resources like self-defense classes.",
